...
- [ ] **Step 1: 实现 runtime config loader**
...
- [ ] **Step 4: 实现 child Pi settings 写入或传递**
...
- [ ] **Step 3: 实现 result parser 和 validator**
...
- [ ] **Step 2: 实现 queued task cancel 和 attempt lifecycle**
...
- [ ] **Step 4: 增加 replace 后 stale event 诊断测试**
